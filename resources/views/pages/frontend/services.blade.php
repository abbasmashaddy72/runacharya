<x-front-layout>
    <!-- Start -->
    <section class="relative py-16 mt-6 md:py-24" id="multispeciality">
        <div class="container">
            <div class="grid grid-cols-1 pb-8 text-center">
                <h3 class="mb-6 text-2xl font-medium leading-normal md:text-3xl md:leading-normal dark:text-white">
