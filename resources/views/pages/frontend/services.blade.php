                        ...
                        <div class="lg:col-span-4 md:col-span-6">
                            <a href="{{ route('service_single', ['data' => $key_item->id]) }}">
                                <div
                                    ...
                                    <div
                                        class="flex items-center p-2 justify-center h-[45px] min-w-[45px] -rotate-50 bg-gradient-to-r from-transparent to-indigo-600/10 text-indigo-600 text-center rounded-full mr-3">
