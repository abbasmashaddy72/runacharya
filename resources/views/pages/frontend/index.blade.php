<x-front-layout>
    ...
    <!-- FEATURES START -->
    <section class="relative py-16 bg-gray-50 dark:bg-slate-800 md:py-24 mt-40">
        <div class="container">
            <div class="grid justify-center grid-cols-1">
                <div class="relative -mt-40 lg:-mt-48">
                    <div class="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-[24px]">
                        @for ($i = 1; $i <= count($feature); $i++)
                            <div
                                class="p-6 text-center text-white transition-all duration-500 ease-in-out rounded-lg shadow group md:px-4 dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 dark:bg-slate-900 bg-gradient-to-r from-fuchsia-700 to-fuchsia-500">
                                {{-- <div
                                ...
                                <div class="content">
                                    <a href="{{ $feature['feature_' . $i]['hero_feature_url_' . $i] }}"
                                        class="text-lg font-medium title h5 text-white hover:text-gray-900">
            ...
            @foreach ($services as $item => $key)
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 mt-8 gap-[30px]">
                    @foreach ($key as $key_item)
                        <div class="p-6 hover:shadow-xl hover:shadow-gray-100 transition duration-500 rounded-2xl mt-6">
                            <div
                                class="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-xl text-3xl flex align-middle justify-center items-center shadow-sm">
