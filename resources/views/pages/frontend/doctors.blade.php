        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                <div class="lg:col-span-4 md:col-span-6">
                    <div
                        class="flex items-center p-3 text-white transition-all duration-500 ease-in-out bg-white rounded-md shadow bg-sky-100 hover:scale-105 dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 dark:bg-slate-900">
                        <div
